...
def webDriver():
    with keepawake(keep_screen_awake=True):
        ...
        chromeDriver = webdriver.Chrome(
            options=webDriverErrorResolver, service=Service(ChromeDriverManager().install()))
...
def scrapingProcess():
    ...
    for index in range(int(totalSiteCount)):
        ...
        if (isLive):
            ...
            print(host, 'host')
            numberOfColumnsInSelectedSite = host.find_elements(By.XPATH, "/html/body/div[1]/div/div[2]/div[1]/div[2]/section/div[4]/div[2]/div[1]/section/div/div/div/div[1]/div/section/div[4]/div/div/div[2]/div[1]/div/div/div[1]/div")
            ...
            print(len(numberOfColumnsInSelectedSite), 'len')
            for i in range(0, len(numberOfColumnsInSelectedSite), 1):
                columnHeaderInSelectedSite = host.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[1]/div[2]/section/div[4]/div[2]/div[1]/section/div/div/div/div[1]/div/section/div[4]/div/div/div[2]/div[1]/div/div/div[1]/div['+str(i+1)+']/button/span[1]')
            ...
            print(len(chromeDriver.find_elements(By.XPATH, "//*[@id='root']/div/div[2]/div[1]/div[2]/section/div[4]/div[2]/div[1]/section/div/div/div/div[1]/div/section/div[4]/div/div/div[2]/div[1]/div/div/div[1]/div")))
            isMonitoringData = chromeDriver.find_elements(By.XPATH, "//*[@id='root']/div/div[2]/div[1]/div[2]/section/div[4]/div[2]/div[1]/section/div/div/div/div[1]/div/section/div[4]/div/div/div[2]/div[1]/div/div/div[1]/div")
            ...
            if len(isMonitoringData) > 0:
                ...
                for i in range(1, len(isMonitoringData), 1):
                    if (i % 7 == 0):
                        ...
                        monitoringDataOfSelectedSite = chromeDriver.find_element(By.XPATH, '/html/body/div[1]/div/div[2]/div[1]/div[2]/section/div[4]/div[2]/div[1]/section/div/div/div/div[1]/div/section/div[4]/div/div/div[2]/div[1]/div/div/div[2]/span['+str(i)+']')
